...
/* INSERTS */
SET IDENTITY_INSERT imagenes OFF;
SET IDENTITY_INSERT autor OFF;  
SET IDENTITY_INSERT genero OFF;
SET IDENTITY_INSERT libro OFF;

ALTER TABLE libro 
ALTER COLUMN sinapsis TEXT

ALTER TABLE libro
ALTER COLUMN contenido TEXT NULL;
...
VALUES ('1', 'Harry Potter y la piedra filosofal', 'Harry Potter se ha quedado huérfano y vive en casa
	   ...
	   Harry no es un chico común y corriente. íEs un verdadero mago!', '1997-06-26', 1, 1, 3),
	   ...
	   llegar antes al paraíso... En fin, todo un ramillete de emociones y escalofríos, cuyas flores se abren por la noche...', '1980-01-01', 2, 1, 9),
	   ...
	   renovador de la fantasía del siglo XXI y el autor del género más prolífico del mundo.', '2006-07-17', 3, 1, 8),
	   ...
	   estaba perdido en el desierto.', '1943-04-06', 4, 1, 3),
	   ...
	   de una conspiración que pretende apoderarse del tesoro de Smaug el Magnífico, un enorme y muy peligroso dragón...', '1937-09-21', 5, 1, 3),
	   ...
	   Su Diario nunca morirá.', '1947-06-25', 6, 1, 4),
	   ...
	   una crítica mordaz y humorística de la sociedad y el mundo de la época.', '1605-01-26', 7, 1, 5),
	   ...
	   recuperar a sus verdaderos padres, y cumplir así el desafío que le permitirá volver a su vida anterior.', '2002-07-02', 8, 1, 6);
SET IDENTITY_INSERT libro OFF;
