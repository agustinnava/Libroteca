...
function Home() {
  ...
  let [ libro, setLibro ] = useState({
    ...
    sinopsis: "",
    contenido: "",
    fechaEmision: "2023-06-04T22:13:07.625Z",
    autorId: 0,
    generoId: 0,
    autor: null,
    genero: null,
  ...
  const handleSubmit = async (e) => {
    ...
    if(await addLibro(libro)){
      Swal.fire(
        'Listo!',
        `Libro "${libro.titulo}" agregado con éxito.`,
        'success'
      ).then(
        navigate('/admin')
      );
          ...
          <form className='bg-white rounded shadow-lg pt-0' onSubmit={handleSubmit}>
            ...
            <div className='px-5'>
              ...
              <div className="fw-bold fs-5 mb-3">
                ...
                <input type="text" className="form-control fs-5" id="titulo" name="titulo" onChange={handleChange}></input>
              </div>

              <div className="fw-bold fs-5 mb-3">
                <label htmlFor="autor" className="form-label">Autor</label>
                <select className="form-select fs-5" name="autorId" onChange={handleAutorChange}>
                  <option defaultValue={true}>Selecciona un autor</option>
              ...
              <div className="fw-bold fs-5 mb-3">
                ...
                <select className="form-select fs-5" name="generoId" onChange={handleGeneroChange}>
